...
def process_video(video_path, output_dir, fps):
    ...
    for frame in tqdm(frame_generator(video_path, fps=fps, width=info['width'], height=info['height'])):
        ...
        Image.fromarray(frame).save(os.path.join(output_dir, f'{count:05d}.jpg'))
...
if __name__ == "__main__":
    ...
    process_video(args.video_path, args.output_dir, args.fps)
